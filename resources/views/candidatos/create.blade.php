            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex justify-between items-center border-b border-gray-200 dark:border-gray-700 pb-4 mb-4">
                        <h3 class="text-lg font-medium">Preencha os dados do novo candidato</h3>
                    ...
                    <form action="{{ route('candidatos.store') }}" method="POST" novalidate class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <input type="text" id="nome" name="nome" value="{{ old('nome') }}" required aria-required="true" autocomplete="name"
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email') }}" required aria-required="true" autocomplete="email" inputmode="email"
                        ...
                        <div x-data x-init="IMask($refs.telefone, { mask: '(00) 00000-0000' })">
                            ...
                            <input type="tel" id="telefone" name="telefone" x-ref="telefone" value="{{ old('telefone') }}" required aria-required="true" inputmode="tel" placeholder="(99) 99999-9999"
